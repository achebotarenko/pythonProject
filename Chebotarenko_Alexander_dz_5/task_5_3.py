...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей', 'Дмитрий', 'Борис', 'Елена', 'Татьяна', 'Олег']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']


def gen_tutor_klass_list(tutors, klasses):
...
full_list = gen_tutor_klass_list(tutors, klasses)
print(type(full_list))
print(next(full_list))
print(next(full_list))
print(next(full_list))
print(next(full_list))
print(next(full_list))
